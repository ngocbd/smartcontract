/* 
 source code generate by Bui Dinh Ngoc aka ngocbd<buidinhngoc.aiti@gmail.com> for smartcontract EXSCoinToken at 0x036fb05cf88f1d612190d3dbc2ac0769b6a47c60
*/
...
contract BaseExspaceToken is Ownable {
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool) {
        ...
        require (_value <= _allowance); // Check ???µ???±???·?°?‚?µ?»??????. ?? ?‚?°?? ?????????µ?????‚.
        balances[_to] = balances[_to].add(_value);
