/* 
 source code generate by Bui Dinh Ngoc aka ngocbd<buidinhngoc.aiti@gmail.com> for smartcontract Kemonocoin at 0x7f32d1959b5361e884df8c9d017a03f4ce29c8b2
*/
//? ? ? ? ? ? ? ? ? { :??'"?? /?::?::?:::', ???}
//????????????? >'"???/?{???-'???:} ??.? ?
//??????? ? ? ? ?/?? /?|???????? ? ???? ?.?/
