/* 
 source code generate by Bui Dinh Ngoc aka ngocbd<buidinhngoc.aiti@gmail.com> for smartcontract Fomo3DQuick at 0x5ddfc3e78839c40c966ca28017db977e853adcdb
*/
...
contract Fomo3DQuick is F3Devents, Ownable {
    ...
    constructor() public {
        ...
        fees_[0] = 30;   //50% ??, 15% ???, 4% ????, 1% ????
        fees_[1] = 35;   //45% ??, 15% ???, 4% ????, 1% ????
        fees_[2] = 50;   //30% ??, 15% ???, 4% ????, 1% ????
        fees_[3] = 45;   //35% ??, 15% ???, 4% ????, 1% ????

        potSplit_[0] = 30;  //58% ???, 10% ?????, 2% ????
        potSplit_[1] = 25;  //58% ???, 15% ?????, 2% ????
        potSplit_[2] = 10;  //58% ???, 30% ?????, 2% ????
        potSplit_[3] = 15;  //58% ???, 25% ?????, 2% ????
	}
