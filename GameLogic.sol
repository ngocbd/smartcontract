/* 
 source code generate by Bui Dinh Ngoc aka ngocbd<buidinhngoc.aiti@gmail.com> for smartcontract GameLogic at 0x5d84827b41abefd47af454f77227dab4895c47a9
*/
...
library Datasets {
    ...
    struct Beter {
        uint256 betId;       // ???
        bool beted;          // ???????????
        BetTypeEnum betType; // ????   1 dragon   2tiger
        uint256 amount;      // ??
        uint256 value;       // ???
    }
    //coin??
...
contract GameLogic {
    ...
    mapping(uint256 => mapping(uint8 => Datasets.Beter[])) public mapBetter;        // rid -> betType -> Beter[index] ????????
