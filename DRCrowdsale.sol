/* 
 source code generate by Bui Dinh Ngoc aka ngocbd<buidinhngoc.aiti@gmail.com> for smartcontract DRCrowdsale at 0x6741d0a12a354e0c11a9d40c31c0d43297b9f890
*/
...
contract DRCrowdsale is Ownable {
  ...
  uint256 public price = 2; //token????0.00002ETH?? (?????0.077?)
  uint256 public constant increasedPrice = 2;  //0.00002ETH (???????increasedPrice)
