/* 
 source code generate by Bui Dinh Ngoc aka ngocbd<buidinhngoc.aiti@gmail.com> for smartcontract ERC20 at 0xb10441f945aa16c9a765ea5baef65cf3e49bbd08
*/
...
contract ERC20 is ERC20Interface, BobbyERC20Base {
    ...
    struct UserToken {
        ...
        address addr;                   //????
        uint256 tokens;                 //????
        LockedToken[] lockedTokens;     //???token
    }

    mapping(address=>UserToken) private _userMap;           //????
    address[] private _userArray;                           //????,from 1
