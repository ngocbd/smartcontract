/* 
 source code generate by Bui Dinh Ngoc aka ngocbd<buidinhngoc.aiti@gmail.com> for smartcontract F3G at 0xc8acf5ffd26c5cc10e124503b5ca55d249a2dc31
*/
...
contract F3G {
    ...
    constructor() public {
        ...
        fees_[0] = F3GDatasets.TeamFee(36,3); //40% to pot, 15% to aff, 3% to com, 2% to ????, 1% to air drop pot
        fees_[1] = F3GDatasets.TeamFee(43,3);  //33% to pot, 15% to aff, 3% to com, 2% to ????, 1% to air drop pot
        fees_[2] = F3GDatasets.TeamFee(66,3); //10% to pot, 15% to aff, 3% to com, 2% to  ????, 1% to air drop pot
