/* 
 source code generate by Bui Dinh Ngoc aka ngocbd<buidinhngoc.aiti@gmail.com> for smartcontract Token at 0x542ebc8dd94ebe3b2c79b13b641c1b7f3951e0cd
*/
...
contract Token is StandardToken, BurnableToken, Ownable {
    ...
    */
    function getLockedAmount(address _addr) public view returns (uint256){
        ...
        uint256 tokens = initialLockedAmounts[_addr].sub(alpha.mul(initialLockedAmounts[_addr]).div(lockAbsoluteDifference)); // T - (? * T) / ?
